...
public class ClassData {
    ...
    // A HashMap form name of class to ClassBlock 
	...
	public ClassData(HashMap<String, AST.class_> clsMap) {
		...
		classBlock.put("Object", new ClassBlock(clsMap.get("Object"), new HashMap<String, AST.attr>(), objectMethods));
		...
		classBlock.put("IO", new ClassBlock(clsMap.get("IO"), new HashMap<String, AST.attr>(), IOMethods));
		classBlock.get("IO").methodList.putAll(objectMethods);	

        // methods for "Int" and put into ClassBlock
		classBlock.put("Int", new ClassBlock(clsMap.get("Int"), new HashMap<String, AST.attr>(), new HashMap<String, AST.method>()));
		classBlock.get("Int").methodList.putAll(objectMethods);

        // methods for "Bool" and put into ClassBlock
		classBlock.put("Bool", new ClassBlock(clsMap.get("Bool"), new HashMap<String, AST.attr>(), new HashMap<String, AST.method>()));
		...
		classBlock.put("String", new ClassBlock(clsMap.get("String"), new HashMap<String, AST.attr>(), stringMethods));
		classBlock.get("String").methodList.putAll(objectMethods);	
	}
	
	public void checkFeatures (AST.class_ cls) {
		ClassBlock c = new ClassBlock(cls, classBlock.get(cls.parent).attributeList, classBlock.get(cls.parent).methodList);
